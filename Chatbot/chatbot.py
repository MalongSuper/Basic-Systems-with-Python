...
# The chatbot_responses.py gets user's input then
# Returns a response
...
def load_chatbot_interface(parent_window, back_to_control_panel):
    # Load icons
    user_icon = load_resized_icon('user_icon.png')
    chatbot_icon = load_resized_icon('chatbot.png')
    back_icon = load_resized_icon('exit_home_button.png')
    # Input frame
...
if __name__ == "__main__":
    ...
    icon_image = Image.open("chatbot.png")
    ...
    set_background(welcome_frame, "background.jpg")
    ...
    def show_chatbot_interface():
        ...
        chatbot_popup.resizable(False, False)

        set_background(chatbot_popup, "background.jpg")
